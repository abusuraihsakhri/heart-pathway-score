"""
Command Line Interface for Heart Pathway Score.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="heart-pathway-score", description="Heart Pathway Score")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Heart Pathway Score Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Heart Pathway Score API server on http://{args.host}:{args.port}")
