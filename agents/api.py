"""
FastAPI REST API Server for Heart Pathway Score.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "heart-pathway-score", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
